  ...
  return (
    ...
    >
      ...
      <div className={`${!certURL && "hidden"}`}>
        <h2 className="py-5 font-medium text-gray-900 dark:text-white">
          Certificate
        </h2>
...
const Trainers = () => {
  ...
  const rating = (
    <Menu onClick={handleRatingClick}>
      <Menu.Item key="1" className={selectedMenuItem === "1" ? "selected" : ""}>
        1 sao
      </Menu.Item>
      <Menu.Item key="2" className={selectedMenuItem === "2" ? "selected" : ""}>
        2 sao
      </Menu.Item>
      <Menu.Item key="3" className={selectedMenuItem === "3" ? "selected" : ""}>
        3 sao{" "}
      </Menu.Item>
      <Menu.Item key="4" className={selectedMenuItem === "4" ? "selected" : ""}>
        4 sao
      </Menu.Item>
      <Menu.Item key="5" className={selectedMenuItem === "5" ? "selected" : ""}>
        5 sao
      </Menu.Item>
    </Menu>
  );
  ...
  const field = (
    <Menu onClick={handleFieldClick}>
      <Menu.Item
        key="yoga"
        className={selectedMenuItem === "yoga" ? "selected" : ""}
      >
        yoga
      </Menu.Item>
      <Menu.Item
        key="boxing"
        className={selectedMenuItem === "boxing" ? "selected" : ""}
      >
        boxing
      </Menu.Item>
      <Menu.Item
        key="aerobic"
        className={selectedMenuItem === "aerobic" ? "selected" : ""}
      >
        aerobic
      </Menu.Item>
      <Menu.Item
        key="taekwondo"
        className={selectedMenuItem === "taekwondo" ? "selected" : ""}
      >
        taekwondo
      </Menu.Item>
      <Menu.Item
        key="pilates"
        className={selectedMenuItem === "pilates" ? "selected" : ""}
      >
        pilates
      </Menu.Item>
    </Menu>
  ...
  const paginatedList = paginate(sortedList, currentPage, pageSize, selectedMenuItem, loading);
        ...
        <div className="container">
          ...
          >
            ...
            <Button
              type="primary"
              style={{
                background: filter === "all" ? "#0080ff" : "#4b5c988f",
                fontMedium: true,
                roundedLg: true,
                textSm: true,
                px: 8,
            ...
            <Dropdown overlay={rating} placement="bottomLeft">
              <Button
                type="primary"
                style={{
                  background: filter === "rating" ? "#0080ff" : "#4b5c988f",
                  fontMedium: true,
                  roundedLg: true,
                  textSm: true,
                  px: 8,
            ...
            <Dropdown overlay={field} placement="bottomLeft">
              <Button
                type="primary"
                style={{
                  background: filter === "field" ? "#0080ff" : "#4b5c988f",
                  fontMedium: true,
                  roundedLg: true,
                  textSm: true,
                  px: 8,
            ...
            <Dropdown overlay={price} placement="bottomLeft">
              <Button
                type="primary"
                style={{
                  background: filter === "price" ? "#0080ff" : "#4b5c988f",
                  fontMedium: true,
                  roundedLg: true,
                  textSm: true,
                  px: 8,
          ...
          {loading ? ( // Nếu đang loading, hiển thị loading GIF
